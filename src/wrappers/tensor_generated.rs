...
impl Tensor {
    ...
    pub fn internal_assert_tensor_metadata(
        a: &Tensor, size: impl IntListOption, stride: impl IntListOption, dtype: impl Into<Option<Kind>>, device: Device, layout: Option<Layout>
    ) {
    ...
    pub fn internal_convert_weight_to_int4pack_for_cpu(
        &self, innerktiles: i64
    ) -> Tensor {
    ...
    pub fn internal_cslt_sparse_mm<T: Borrow<Tensor>>(
        compressed_a: &Tensor, dense_b: &Tensor, bias: Option<T>, alpha: Option<T>, out_dtype: impl Into<Option<Kind>>, transpose_result: bool, alg_id: i64, split_k: i64, split_k_mode: i64
    ) -> Tensor {
        Tensor::f_internal_cslt_sparse_mm(compressed_a, dense_b, bias, alpha, out_dtype, transpose_result, alg_id, split_k, split_k_mode).unwrap()
    }
    ...
    pub fn internal_cudnn_attention_backward(
        grad_out: &Tensor, query: &Tensor, key: &Tensor, value: &Tensor, out: &Tensor, logsumexp: &Tensor, philox_seed: &Tensor, philox_offset: &Tensor, attn_bias: &Tensor, cum_seq_q: &Tensor, cum_seq_k: &Tensor, max_q: i64, max_k: i64, dropout_p: f64, is_causal: bool, scale: impl Into<Option<f64>>
    ) -> (Tensor, Tensor, Tensor) {
        Tensor::f_internal_cudnn_attention_backward(grad_out, query, key, value, out, logsumexp, philox_seed, philox_offset, attn_bias, cum_seq_q, cum_seq_k, max_q, max_k, dropout_p, is_causal, scale).unwrap()
    }
    ...
    pub fn internal_dyn_quant_matmul_4bit(
        inp: &Tensor, packed_weights: &Tensor, block_size: i64, in_features: i64, out_features: i64
    ) -> Tensor {
        Tensor::f_internal_dyn_quant_matmul_4bit(inp, packed_weights, block_size, in_features, out_features).unwrap()
    }

    pub fn internal_dyn_quant_pack_4bit_weight<T: Borrow<Tensor>>(
        weights: &Tensor, scales_zeros: &Tensor, bias: Option<T>, block_size: i64, in_features: i64, out_features: i64
    ) -> Tensor {
        Tensor::f_internal_dyn_quant_pack_4bit_weight(weights, scales_zeros, bias, block_size, in_features, out_features).unwrap()
    }
    ...
    pub fn internal_flash_attention_backward(
        grad_out: &Tensor, query: &Tensor, key: &Tensor, value: &Tensor, out: &Tensor, logsumexp: &Tensor, cum_seq_q: &Tensor, cum_seq_k: &Tensor, max_q: i64, max_k: i64, dropout_p: f64, is_causal: bool, rng_state: &Tensor, unused: &Tensor, scale: impl Into<Option<f64>>, window_size_left: impl Into<Option<i64>>, window_size_right: impl Into<Option<i64>>
    ) -> (Tensor, Tensor, Tensor) {
        Tensor::f_internal_flash_attention_backward(grad_out, query, key, value, out, logsumexp, cum_seq_q, cum_seq_k, max_q, max_k, dropout_p, is_causal, rng_state, unused, scale, window_size_left, window_size_right).unwrap()
    }
    ...
    pub fn internal_grouped_mm<T: Borrow<Tensor>>(
        &self, mat2: &Tensor, offs: Option<T>, bias: Option<T>, out_dtype: impl Into<Option<Kind>>
    ) -> Tensor {
    ...
    pub fn internal_nested_from_padded_tensor<T: Borrow<Tensor>>(
        padded: &Tensor, offsets: &Tensor, dummy: &Tensor, ragged_idx: i64, min_seqlen: Option<T>, max_seqlen: Option<T>, sum_s: impl Into<Option<i64>>
    ) -> Tensor {
        Tensor::f_internal_nested_from_padded_tensor(padded, offsets, dummy, ragged_idx, min_seqlen, max_seqlen, sum_s).unwrap()
    }
    ...
    pub fn internal_scaled_dot_product_cudnn_attention_backward(
        ...
        Tensor::f_internal_scaled_dot_product_cudnn_attention_backward(grad_out, query, key, value, out, logsumexp, philox_seed, philox_offset, attn_bias, cum_seq_q, cum_seq_k, max_q, max_k, dropout_p, is_causal, scale).unwrap()
    }
    ...
    pub fn internal_scaled_grouped_mm<T: Borrow<Tensor>>(
        &self, mat2: &Tensor, scale_a: &Tensor, scale_b: &Tensor, offs: Option<T>, bias: Option<T>, scale_result: Option<T>, out_dtype: impl Into<Option<Kind>>, use_fast_accum: bool
    ) -> Tensor {
        self.f_internal_scaled_grouped_mm(mat2, scale_a, scale_b, offs, bias, scale_result, out_dtype, use_fast_accum).unwrap()
    }

    pub fn internal_scaled_mm<T: Borrow<Tensor>>(
        &self, mat2: &Tensor, scale_a: &Tensor, scale_b: &Tensor, bias: Option<T>, scale_result: Option<T>, out_dtype: impl Into<Option<Kind>>, use_fast_accum: bool
    ) -> Tensor {
        self.f_internal_scaled_mm(mat2, scale_a, scale_b, bias, scale_result, out_dtype, use_fast_accum).unwrap()
    }

    pub fn internal_scaled_mm_out<T: Borrow<Tensor>>(
        &self, out: &Tensor, mat2: &Tensor, scale_a: &Tensor, scale_b: &Tensor, bias: Option<T>, scale_result: Option<T>, out_dtype: impl Into<Option<Kind>>, use_fast_accum: bool
    ) -> Tensor {
        self.f_internal_scaled_mm_out(out, mat2, scale_a, scale_b, bias, scale_result, out_dtype, use_fast_accum).unwrap()
    }
    ...
    pub fn internal_validate_sparse_bsc_tensor_args(
        ccol_indices: &Tensor, row_indices: &Tensor, values: &Tensor, size: impl IntList, check_pinning: bool
    ) {
        Tensor::f_internal_validate_sparse_bsc_tensor_args(ccol_indices, row_indices, values, size, check_pinning).unwrap()
    }

    pub fn internal_validate_sparse_bsr_tensor_args(
        crow_indices: &Tensor, col_indices: &Tensor, values: &Tensor, size: impl IntList, check_pinning: bool
    ) {
        Tensor::f_internal_validate_sparse_bsr_tensor_args(crow_indices, col_indices, values, size, check_pinning).unwrap()
    }

    pub fn internal_validate_sparse_compressed_tensor_args(
        compressed_indices: &Tensor, plain_indices: &Tensor, values: &Tensor, size: impl IntList, layout: Layout, check_pinning: bool
    ) {
        Tensor::f_internal_validate_sparse_compressed_tensor_args(compressed_indices, plain_indices, values, size, layout, check_pinning).unwrap()
    }

    pub fn internal_validate_sparse_csc_tensor_args(
        ccol_indices: &Tensor, row_indices: &Tensor, values: &Tensor, size: impl IntList, check_pinning: bool
    ) {
        Tensor::f_internal_validate_sparse_csc_tensor_args(ccol_indices, row_indices, values, size, check_pinning).unwrap()
    }

    pub fn internal_validate_sparse_csr_tensor_args(
        crow_indices: &Tensor, col_indices: &Tensor, values: &Tensor, size: impl IntList, check_pinning: bool
    ) {
        Tensor::f_internal_validate_sparse_csr_tensor_args(crow_indices, col_indices, values, size, check_pinning).unwrap()
    }
    ...
    pub fn internal_weight_int4pack_mm_with_scales_and_zeros(
        &self, mat2: &Tensor, qgroupsize: i64, qscale: &Tensor, qzeros: &Tensor
    ) -> Tensor {
        self.f_internal_weight_int4pack_mm_with_scales_and_zeros(mat2, qgroupsize, qscale, qzeros).unwrap()
    }
    ...
    pub fn adaptive_avg_pool1d_out(
        &self, out: &Tensor, output_size: impl IntList
    ) -> Tensor {
    ...
    pub fn addmm_dtype(
        &self, mat1: &Tensor, mat2: &Tensor, out_dtype: Kind
    ) -> Tensor {
        self.f_addmm_dtype(mat1, mat2, out_dtype).unwrap()
    }

    pub fn addmm_dtype_out(
        &self, out: &Tensor, mat1: &Tensor, mat2: &Tensor, out_dtype: Kind
    ) -> Tensor {
    ...
    pub fn avg_pool1d_out(
        &self, out: &Tensor, kernel_size: impl IntList, stride: impl IntList, padding: impl IntList, ceil_mode: bool, count_include_pad: bool
    ) -> Tensor {
        self.f_avg_pool1d_out(out, kernel_size, stride, padding, ceil_mode, count_include_pad).unwrap()
    }
    ...
    pub fn baddbmm_dtype<S: Into<Scalar>>(
        &self, batch1: &Tensor, batch2: &Tensor, out_dtype: Kind, beta: S, alpha: S
    ) -> Tensor {
        self.f_baddbmm_dtype(batch1, batch2, out_dtype, beta, alpha).unwrap()
    }

    pub fn baddbmm_dtype_out(
        &self, out: &Tensor, batch1: &Tensor, batch2: &Tensor, out_dtype: Kind
    ) -> Tensor {
    ...
    pub fn bmm_dtype(
        &self, mat2: &Tensor, out_dtype: Kind
    ) -> Tensor {
        self.f_bmm_dtype(mat2, out_dtype).unwrap()
    }

    pub fn bmm_dtype_out(
        &self, out: &Tensor, mat2: &Tensor, out_dtype: Kind
    ) -> Tensor {
    ...
    pub fn fbgemm_linear_fp16_weight_fp32_activation<T: Borrow<Tensor>>(
        &self, packed_weight: &Tensor, bias: Option<T>
    ) -> Tensor {
        self.f_fbgemm_linear_fp16_weight_fp32_activation(packed_weight, bias).unwrap()
    }

    pub fn fbgemm_linear_fp16_weight_fp32_activation_out<T: Borrow<Tensor>>(
        &self, packed_weight: &Tensor, bias: Option<T>, output: &Tensor
    ) -> Tensor {
        self.f_fbgemm_linear_fp16_weight_fp32_activation_out(packed_weight, bias, output).unwrap()
    }

    pub fn fbgemm_linear_fp16_weight_out(
        &self, packed_weight: &Tensor, bias: &Tensor, output: &Tensor
    ) -> Tensor {
        self.f_fbgemm_linear_fp16_weight_out(packed_weight, bias, output).unwrap()
    }
    ...
    pub fn hash_tensor(
        &self, dim: impl IntList, keepdim: bool, mode: i64
    ) -> Tensor {
        self.f_hash_tensor(dim, keepdim, mode).unwrap()
    }

    pub fn hash_tensor_out(
        &self, out: &Tensor, dim: impl IntList, keepdim: bool, mode: i64
    ) -> Tensor {
    ...
    pub fn randint_like_tensor(
        &self, high: &Tensor
    ) -> Tensor {
        self.f_randint_like_tensor(high).unwrap()
    }

    pub fn randint_like_tensor_out(
        &self, out: &Tensor, high: &Tensor
    ) -> Tensor {
    ...
    pub fn rrelu_with_noise_functional(
        &self, noise: &Tensor, training: bool
    ) -> (Tensor, Tensor) {
    ...
    pub fn stft<T: Borrow<Tensor>>(
        &self, n_fft: i64, hop_length: impl Into<Option<i64>>, win_length: impl Into<Option<i64>>, window: Option<T>, normalized: bool, onesided: bool, return_complex: bool, align_to_window: bool
    ) -> Tensor {
        self.f_stft(n_fft, hop_length, win_length, window, normalized, onesided, return_complex, align_to_window).unwrap()
    }

    pub fn stft_center<T: Borrow<Tensor>>(
        &self, n_fft: i64, hop_length: impl Into<Option<i64>>, win_length: impl Into<Option<i64>>, window: Option<T>, center: bool, pad_mode: &str, normalized: bool, onesided: bool, return_complex: bool, align_to_window: bool
    ) -> Tensor {
        self.f_stft_center(n_fft, hop_length, win_length, window, center, pad_mode, normalized, onesided, return_complex, align_to_window).unwrap()
    }
    ...
    pub fn upsample_bilinear2d_vec_out(
        &self, out: &Tensor, output_size: impl IntListOption, align_corners: bool, scale_factors: impl DoubleList
    ) -> Tensor {
    ...
    pub fn upsample_nearest2d_vec_out(
        &self, out: &Tensor, output_size: impl IntListOption, scale_factors: impl DoubleList
    ) -> Tensor {
