...
void atg__pin_memory(tensor *, tensor self, int device_v, uint8_t device_null);
void atg__pin_memory_out(tensor *, tensor out, tensor self, int device_v, uint8_t device_null);
